import { SL_STAM_MAX, SL_STAM_STEP_MS, SL_ORB_MAX, SL_ORB_STEP_MS } from './starleap-state.mjs?rev=lunaby-v2-r21';
export { createSLState, SL_STAM_MAX, SL_STAM_STEP_MS, SL_ORB_MAX, SL_ORB_STEP_MS } from './starleap-state.mjs?rev=lunaby-v2-r21';
