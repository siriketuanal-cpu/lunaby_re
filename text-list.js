import { applyStam, createSlots, displaySnapshot, hasTimedProgress, isSlotEnabled, liveStam, remainingAfter40, restartIdle, setLabel, setRank, formatClock } from './abyss-runtime-core.mjs?rev=lunaby-v2-r23';
import { saveV2Store } from './lunaby-v2-store.mjs?rev=lunaby-v2-r23';
import * as starleapRuntime from './starleap-lite-core.mjs?rev=lunaby-v2-r23';
